...
const AdminManagement = () => {
  ...
  const handleRemoveAdmin = (userId: string, userEmail: string) => {
    ...
    const initialAdmins = ['admin@shadow.com', 'maazajaz1234@gmail.com', 'test@admin.com'];
              ...
              {adminUsers.map((admin, index) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    {['admin@shadow.com', 'maazajaz1234@gmail.com', 'test@admin.com'].includes(admin.email.toLowerCase()) && (
                    ...
                    <Button
                      ...
                      title={
                        ...
                        ['admin@shadow.com', 'maazajaz1234@gmail.com', 'test@admin.com'].includes(admin.email.toLowerCase()) ? "Cannot remove super admin" :
